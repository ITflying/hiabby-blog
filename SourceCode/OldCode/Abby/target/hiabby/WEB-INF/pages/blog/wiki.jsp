...
<html>
<head>
  <title>Abby`s Blog - Wiki</title>

  <link rel="stylesheet" href="static/hiabbyWebsite/wiki/wiki.css?v=1.0"/>
...
<main class="page-content" aria-label="Content">
  <div class="wrapper">
    <div class="home">
      <h1 class="page-heading">Wiki</h1>
      <ul class="post-list">
        <li>
          <div class="centerPic"><img src="files/index/wiki.jpg"/></div>
          <div class="wikiTitle">“互联网精神”：开放、平等、协作、快速、分享。</div>
          <div class="wikiIntroduce">
            嗯，这里就是用来放各种各式各样的资源、网站、链接等等，慢慢来整理吧。
          </div>
          <hr>
