        ...
        <div class="wrapper">
            ...
            <nav class="site-nav">
                ...
                <div class="trigger">
                    ...
                    <a v-for="page in pages" :key="page.id" class="page-link" :href="`${page.href}`"><span :class="`iconfont ${page.icon}`" style="margin-right:1px;"></span>{{page.text}}</a>
                </div>
            </nav>
        </div>
    </header>
...
<style scoped>
    ...
    @import '../../assets/less/base/header.less';
</style>
